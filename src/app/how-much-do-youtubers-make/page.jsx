        ...
        <section className="calc-content" aria-label="About the YouTube revenue calculator">
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    To give you a realistic estimate, you can try the calculator below before reading further.
                </p>
                <p className="calc-content__p">
                    The estimate depends on the inputs that actually move YouTube revenue: views, retention, niche, geography, duration, and format. It is a modeling tool, not a guaranteed payout calculator, because real earnings change with ad demand, seasonality, and channel performance.
                </p>
            ...
            <div className="calc-content__block">
                ...
                <div className="calc-content__metrics">
                    ...
                    <div className="calc-content__metric-card">
                        ...
                        <p className="calc-content__p">
                            CPM is what advertisers pay for 1,000 ad impressions before YouTube’s cut. It is usually higher than RPM. A common mistake is to treat CPM as if it were creator earnings, but it is not. CPM is useful because it shows advertiser demand, especially in high-value niches and during strong seasonal periods like Q4.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Why niche matters</h3>
                        <p className="calc-content__p">
                            The topic of the video changes the value of the audience. Finance, investing, software, business, and legal content usually attract stronger advertiser competition than gaming, vlogs, or broad entertainment. That is why two videos with identical views can earn very different amounts: the audience intent behind the content is not the same.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Why geography changes revenue</h3>
                        <p className="calc-content__p">
                            Audience location has a major impact on earnings. Viewers from the US, UK, Canada, and Australia generally generate more ad value because advertisers spend more in those markets. A channel with a large share of traffic from high-purchasing-power countries can earn much more than a channel with the same view count but a different geographic mix.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Why retention affects ads shown</h3>
                        <p className="calc-content__p">
                            Retention does more than help the algorithm. It also affects how many ad opportunities are actually served. A viewer who stays longer is more likely to see a pre-roll and, on long-form content, a mid-roll. A video that holds attention well often earns more than a longer video with weak pacing because the monetization system rewards viewers who keep watching.
                        </p>
                    </div>
                    ...
                    <div className="calc-content__metric-card">
                        ...
                        <p className="calc-content__p">
                            Video length matters because it unlocks mid-roll ads. Under 8 minutes, you are usually limited. Past that threshold, mid-rolls become possible, and that can raise revenue noticeably. But length alone does not create more earnings. A longer video only helps if the extra time keeps viewers engaged instead of making them leave earlier.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Why Shorts earn differently</h3>
                        <p className="calc-content__p">
                            Shorts do not use the same monetization model as long-form content. They are paid through a shared revenue pool rather than the normal ad impression system. That is why Shorts usually earn less per view, even though they can be excellent for reach, discovery, and subscriber growth.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    The easiest way to understand YouTube revenue is to compare a few scenarios with the same view count.
                </p>
                ...
                <div className="calc-content__scenarios">
                    <div className="calc-content__scenario">
                        ...
                        <p className="calc-content__p">
                            Gaming often sits in a lower RPM range because advertiser competition is weaker and the audience is less likely to be in high-value buyer segments. A video can still perform well in views, but the revenue per view is usually modest.
                        </p>
                    </div>
                    ...
                    <div className="calc-content__scenario">
                        ...
                        <p className="calc-content__p">
                            Finance content usually earns much more because advertisers pay more to reach viewers with strong commercial intent. Even at the same view count, the difference can be dramatic. This is one of the clearest examples of why views alone do not predict income.
                        </p>
                    </div>
                    ...
                    <div className="calc-content__scenario">
                        ...
                        <p className="calc-content__p">
                            Educational and how-to content often lands between gaming and finance. If the video is long enough to unlock mid-rolls and keeps people watching, it can earn surprisingly well. A well-paced tutorial can outperform a much more “popular” format because the audience is more valuable to advertisers.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <ul className="calc-content__steps">
                    <li>
                        <strong>“Views equal money” is wrong</strong> — the same view count can produce very different revenue depending on niche, geography, retention, and length.
                    </li>
                    <li>
                        <strong>CPM is not what creators earn</strong> — CPM is the advertiser-side rate. RPM is closer to the creator’s actual payout.
                    </li>
                    <li>
                        <strong>Shorts revenue is pooled</strong> — Shorts are paid from a shared fund, not the same ad system used by long-form videos.
                    </li>
                    <li>
                        <strong>Longer is not always better</strong> — more minutes only help when those minutes keep people watching.
                    </li>
                </ul>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    You can test different scenarios using the calculator above. Try changing the niche, switching the audience country, or adjusting the video length and retention rate. The numbers will show quickly how sensitive YouTube earnings are to those variables.
                </p>
                <p className="calc-content__p">
                    That is usually the fastest way to move from vague guesses to a more realistic monetization estimate.
                </p>
            </div>
            ...
            <div className="calc-content__faq" id="faq">
                ...
                <p className="calc-content__p" style={{ marginBottom: "2rem" }}>
                    These answers cover the main factors that influence YouTube revenue: RPM, CPM, Shorts, length, retention, and geography.
                </p>
                    ...
                    {[
                        {
                            ...
                            a: "It provides a working estimate, not a guaranteed number. The model uses observed RPM benchmarks by niche, as well as adjustments for geography, format, length, and retention. In real life, the gap also depends on seasonality, available ad inventory, adblock rates, and audience variations. For creators, the main point is not getting an exact cent value, but understanding the order of magnitude and the levers that move revenue."
                        },
                        {
                            q: "What is the difference between RPM and CPM on YouTube?",
                            a: "CPM is what advertisers pay for 1,000 ad impressions before YouTube’s share. RPM is what the creator actually earns per 1,000 views after YouTube’s share and after monetization conditions are taken into account. This is why a high CPM does not automatically become a high payout."
                        },
                        {
                            q: "Why do Shorts pay less than long-form videos?",
                            a: "Shorts are based on a different economic model. They use a shared revenue pool distributed among eligible creators according to the watch time they capture. Because the system is not based on the same ad placement structure as long-form, earnings per view are usually lower."
                        },
                        {
                            q: "Which YouTube niche has the best RPM?",
                            a: "Finance, investing, software, real estate, law, and certain business topics often have the highest RPMs. Their audiences tend to have stronger commercial intent, so advertisers compete more for them. Gaming, general entertainment, and some vlog formats usually sit lower."
                        },
                        {
                            q: "Does video length really change revenue?",
                            a: "Yes, because it changes ad serving opportunities. Past 8 minutes, mid-roll ads become possible. That can increase revenue without increasing views, but only if the video keeps viewers engaged. A longer video with weak retention often underperforms."
                        },
                        {
                            q: "How does audience geography influence revenue?",
                            a: "Much more than most beginners expect. Viewers from the US, UK, Canada, and other high-value markets often generate more revenue because advertisers bid more aggressively there. The same video can earn very different amounts depending on where the audience lives."
                        },
                        {
                            q: "What retention rate should I enter?",
                            a: "If you do not have your own data yet, 45% is a reasonable baseline for a standard long-form video. Highly engaging videos can exceed that, while slower or broader videos often come in lower."
                        },
                        {
