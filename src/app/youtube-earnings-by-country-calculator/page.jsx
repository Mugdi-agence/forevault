        ...
        <section className="calc-content" aria-label="About the YouTube earnings by country calculator">
            ...
            <div className="calc-content__stats" role="list">
                ...
                <div className="calc-content__stat" role="listitem">
                    ...
                    <span className="calc-content__stat-label">Niches with RPM data</span>
                </div>
                <div className="calc-content__stat" role="listitem">
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    The estimate depends on the variables that matter most for country-based revenue: views, retention, niche, audience geography, video duration, and format. It is a modeling tool, not a guaranteed payout calculator, because actual YouTube earnings shift with advertiser demand, seasonality, and audience quality.
                </p>

                <div className="calc-content__embed-placeholder" aria-label="YouTube Earnings by Country Calculator Embed">
                    [YouTube Earnings by Country Calculator Embed]
                </div>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <div className="calc-content__metrics">
                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">RPM reflects real creator earnings</h3>
                        <p className="calc-content__p">
                            RPM is the amount a creator earns per 1,000 views after YouTube’s share. It is the most useful number for comparing countries because it captures the revenue that actually reaches the creator. When the country mix changes, RPM usually changes with it.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Advertiser demand is not equal everywhere</h3>
                        <p className="calc-content__p">
                            Some markets have much stronger competition for ad inventory. Brands spend more aggressively in countries where the audience has higher purchasing power, stronger commercial intent, or a larger base of advertisers. That is why a view from one country can be worth several times more than a view from another.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">The same niche pays differently by region</h3>
                        <p className="calc-content__p">
                            Geography does not act alone. A finance video with a US audience often monetizes far better than the same finance video with a lower-value regional mix. The topic matters, but the country of the audience often decides how much that topic is worth in the ad market.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Retention influences the final payout</h3>
                        <p className="calc-content__p">
                            A viewer from a high-value country only helps if they actually watch enough of the video for ads to be served. Strong retention increases the chances of monetization across the video, while weak retention can drag revenue down even when the audience comes from a premium market.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Video length still matters</h3>
                        <p className="calc-content__p">
                            Long-form videos over 8 minutes can unlock mid-roll ads. That means a creator with a strong audience in a high-value country may earn noticeably more from a 10-minute video than from a shorter version of the same idea. Country affects the value of the view, but duration affects how many monetization opportunities exist inside that view.
                        </p>
                    </div>

                    <div className="calc-content__metric-card">
                        <h3 className="calc-content__h3">Shorts are different</h3>
                        <p className="calc-content__p">
                            Shorts use a separate revenue model based on a shared pool rather than the standard long-form ad system. Because of that, country still matters, but the earnings pattern is usually much lower per view. Shorts can be useful for reach, but they are rarely the strongest direct revenue format.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    The easiest way to understand country-based earnings is to compare the same content with different audience locations.
                </p>

                <div className="calc-content__scenarios">
                    <div className="calc-content__scenario">
                        <h3 className="calc-content__h3">100K views with a US-heavy audience</h3>
                        <p className="calc-content__p">
                            A US-heavy audience usually generates stronger RPM because advertiser competition is intense and the market is highly valuable. This is why creators with a large share of US viewers often see higher payouts even when their view counts are similar to other channels.
                        </p>
                    </div>

                    <div className="calc-content__scenario">
                        <h3 className="calc-content__h3">100K views with a UK or Canadian audience</h3>
                        <p className="calc-content__p">
                            The UK and Canada typically monetize well too, often sitting in a strong middle-to-high range depending on niche. A channel with viewers concentrated in these countries can earn solid revenue, especially when the content is business, education, finance, or software-related.
                        </p>
                    </div>

                    <div className="calc-content__scenario">
                        <h3 className="calc-content__h3">100K views with a lower-bid regional mix</h3>
                        <p className="calc-content__p">
                            If the audience is concentrated in countries where ad budgets are lower, the same 100K views may produce much less revenue. The content may still perform well in reach and engagement, but the monetization outcome will usually be more modest.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <ul className="calc-content__steps">
                    <li>
                        <strong>“All countries pay roughly the same” is wrong</strong> — geography is one of the biggest RPM drivers on YouTube.
                    </li>
                    <li>
                        <strong>“More views always means more money” is wrong</strong> — 100K views in one country mix can pay far more than 100K in another.
                    </li>
                    <li>
                        <strong>“CPM is what creators earn” is wrong</strong> — CPM is advertiser-side pricing, while RPM is much closer to actual creator income.
                    </li>
                    <li>
                        <strong>“Shorts behave like long-form” is wrong</strong> — Shorts use a different monetization structure and usually earn less per view.
                    </li>
                </ul>
            </div>
            ...
            <div className="calc-content__block">
                ...
                <p className="calc-content__p">
                    You can test different scenarios using the calculator above. Try switching the country, niche, or video length and you will see how quickly the revenue estimate changes. That is usually the clearest way to understand why geography matters so much in creator earnings.
                </p>
                <p className="calc-content__p">
                    A good rule of thumb is this: views tell you how much attention you got, but country tells you how valuable that attention may be.
                </p>
            </div>
            ...
            <div className="calc-content__faq" id="faq">
                ...
                <p className="calc-content__p" style={{ marginBottom: "2rem" }}>
                    These answers cover the main factors that influence YouTube earnings by country: RPM, CPM, geography, retention, and format.
                </p>
                    ...
                    {[
                        {
                            ...
                            a: "Because advertisers do not pay the same rates in every market. Countries with stronger purchasing power and more advertiser competition generally produce higher RPM, which means higher creator earnings."
                        },
                        {
                            q: "Which countries usually pay the most on YouTube?",
                            a: "The US, UK, Canada, Australia, and some Western European markets often sit near the top, though the exact result depends on niche, season, and audience behavior. High-value countries usually have stronger ad demand."
                        },
                        {
                            q: "What is the difference between RPM and CPM?",
                            a: "CPM is what advertisers pay for 1,000 ad impressions before YouTube’s share. RPM is what the creator actually earns per 1,000 views after YouTube’s share and after monetization conditions are applied."
                        },
                        {
                            q: "Does audience geography matter more than views?",
                            a: "It can, in a monetization sense. Views are important, but two channels with the same view count can earn very different amounts if their audience country mix is different."
                        },
                        {
                            q: "Do Shorts pay the same across countries?",
                            a: "No. Shorts still vary by audience mix, but they follow a separate revenue model based on a shared pool, so the earnings pattern is different from long-form videos and usually lower per view."
                        },
                        {
                            q: "Does a US audience always mean high earnings?",
                            a: "Not automatically. US traffic usually helps, but niche, retention, and video length still matter. A weak video with strong geography can still underperform."
                        },
                        {
                            q: "What retention rate should I enter?",
                            a: "If you do not have your own analytics yet, 45% is a reasonable baseline for long-form content. Better retention usually improves monetization because it increases the chance that ads are served."
                        },
                        {
