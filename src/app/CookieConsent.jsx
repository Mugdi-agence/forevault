...
function applyGoogleConsent(payload) {
  ...
  const analyticsGranted =
    payload.choice === "all" || Boolean(payload.prefs?.analytics);
  const marketingGranted =
    payload.choice === "all" || Boolean(payload.prefs?.marketing);
          ...
          >
            <div className="cc-details__inner">
              <div className="cc-toggle">
                ...
                <div
                  className="cc-toggle__switch cc-toggle__switch--locked"
