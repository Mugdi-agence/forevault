...
export const niches = [
  ...
  {
    id: "short_food_fitness",
    niche: "Food, Cooking & Fitness (Shorts)",
    topic: "Quick recipes, workouts, wellness tips",
    rpm: 7,
    audienceShare: 0.055,
    faceless: "faceless",
    saturation: 4,
  ...
  },
  {
    ...
    topic: "Comedy sketches, challenges, celebrity news, pets, satisfying clips",
    rpm: 6,
    audienceShare: 0.13,
    faceless: "face",
    saturation: 5,
