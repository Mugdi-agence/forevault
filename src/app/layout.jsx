...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <head>
        {/* Titre : On met la marque en premier pour l'indexation directe */}
        ...
        {/* Open Graph - Pour que tes partages sur les réseaux soient stylés */}
        ...
        <meta name="twitter:description" content="Predict your views and calculate your AdSense revenue with accuracy." />
        <meta name="twitter:image" content="/main.png" />

        <link rel="icon" href="/main.png" />
        
        {/* JSON-LD : C'est ça qui va te faire passer devant les SoundCloud et autres */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }}
        />

        {/* AdSense avec correction crossorigin */}
        <Script 
          async 
